...
async def ban_user(chat_id, i, rights):
    try:
        await legend(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
...
@legend.legend_cmd(
    pattern="unbanall$",
    command=("unbanall", menu_category),
    info={
