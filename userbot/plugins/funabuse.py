...
@legend.legend_cmd(
    pattern="labuse(?:\s|$)([\s\S]*)",
    command=("labuse", menu_category),
    info={
        "header": "Abuse",
        "usage": [
            "{tr}labuse",
...
@legend.legend_cmd(
    pattern="fucked(?:\s|$)([\s\S]*)",
    command=("fucked", menu_category),
    info={
        "header": "Abuse",
        "usage": [
            "{tr}fuk",
...
@legend.legend_cmd(
    pattern="chutiya(?:\s|$)([\s\S]*)",
    command=("chutiya", menu_category),
    info={
        "header": "Abuse",
        "usage": [
            "{tr}chutiya",
...
@legend.legend_cmd(
    pattern="insulted(?:\s|$)([\s\S]*)",
    command=("insulted", menu_category),
    info={
        "header": "Abuse",
        "usage": [
            "{tr}insulted",
...
@legend.legend_cmd(
    pattern="hiabuse(?:\s|$)([\s\S]*)",
    command=("hiabuse", menu_category),
    info={
        "header": "Abuse",
        "usage": [
            "{tr}randi",
