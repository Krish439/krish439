...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [LegendUserBot]<buttonurl:https://t.me/LEGEND_K_USERBOT17:same> [support]<buttonurl:https://t.me/OFFICIAL_K_LEGENDBOT>",
    },
)
async def _(event):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test [google]<buttonurl:https://www.google.com> [LegendUserBot]<buttonurl:https://t.me/LEGEND_K_USERBOT17:same> [support]<buttonurl:https://t.me/OFFICIAL_K_LEGENDBOT>",
    },
)
async def _(event):
    ...
    results = await event.client.inline_query(Config.BOT_USERNAME, catinput)
